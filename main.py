...
YT_CHANNELS = [
    ("BBC Earth", "https://www.youtube.com/@BBCEarthScience/live"),
    ("Science Channel", "https://www.youtube.com/@sciencechannel/live"),
    ...
    ("Zee News", "https://www.youtube.com/@ZeeNews/live"),
    ...
    ("NDTV Profit", "https://www.youtube.com/@NDTVProfitIndia"),
...
def process_youtube_channel(name, url):
    ...
    ytdl_opts = {
        "quiet": True,           # don’t spam logs
        "skip_download": True,   # don’t download video
        "forceid": True,         # equivalent of --get-id
        "extract_flat": True,    # don’t go deep into formats
        'match_filter': yt_dlp.utils.match_filter_func("live_status != 'is_upcoming'"), # ignore scheduled videos
        "ignoreerrors": True,    # skip unavailable/private/deleted videos
        "playlist_items": "1",
    }
    with yt_dlp.YoutubeDL(ytdl_opts) as ydl:
